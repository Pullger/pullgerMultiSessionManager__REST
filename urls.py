...
urlpatterns = [
    ...
    path('task/execute-first', apiREST.ExecuteTaskInTheQueue.as_view()),
    path('task/finalize-all', apiREST.FinalizeAllTask.as_view()),
    path('sessions', apiREST.session_operations_general),
    path('sessions/make-all-authorization', apiREST.make_all_authorization),
